/**
 * Dual Index Search API Lambda Function
...
const createClient = () => {
  return new Client({
    node: `https://${process.env.OPENSEARCH_ENDPOINT || 'vpc-cis-filesearch-opensearch-xuupcgptq6a4opklfeh65x3uqe.ap-northeast-1.es.amazonaws.com'}`,
    auth: {
