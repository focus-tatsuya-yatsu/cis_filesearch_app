/**
 * Dual Index Search API Lambda Function with VPC Support
...
// OpenSearch client configuration with AWS signature
const createClient = () => {
  ...
  // Use AWS signature v4 for authentication within VPC
  const awsConnector = createAwsConnector({
  ...
  return new Client({
    ...
    // Connection settings optimized for VPC
    requestTimeout: 30000,
    connectionClass: require('@opensearch-project/opensearch').Connection,
    ssl: {
