...
| YYYY-MM-DD HH:MM:SS | Data integrity verification started | Engineer: _________ | Executed checklist procedures | Verification log |
| YYYY-MM-DD HH:MM:SS | Rollback decision made | Approver: _________ | Decision: ROLLBACK / NO ACTION | Decision document |
| YYYY-MM-DD HH:MM:SS | Resolution completed | Engineer: _________ | Final state confirmed | Validation report |
...
- **Files Processed During Incident Window**:
  ...
  - Duration: ~20 minutes
  - Estimated Files: _____ (check SQS metrics)
...
1. **OpenSearch Snapshot**
   ...
   - Status: SUCCESS
   - Document Count: _____ (to be verified)

2. **Configuration Snapshots**
   - `.env.local` file state at time of incident
   - Migration script version: git commit hash _____
...
**Target Resolution Date**: _____________

**Actual Resolution Date**: _____________
...
|------|------|-----------|------|
| Incident Commander | _____________ | _____________ | ________ |
| Engineering Manager | _____________ | _____________ | ________ |
