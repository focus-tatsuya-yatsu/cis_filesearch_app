...
const main = async () => {
  ...
  try {
    ...
    console.log(
      `  P95 Latency: ${sequentialResult.metrics.latency.p95.toFixed(2)}ms`
    );
    console.log(
    ...
    console.log(
      `  P95 Latency: ${concurrentResult.metrics.latency.p95.toFixed(2)}ms`
    );
    console.log(
    ...
    console.log(
      `  P95 Latency: ${stressResult.metrics.latency.p95.toFixed(2)}ms`
    );
    console.log(
      `  Throughput: ${stressResult.metrics.throughput.queriesPerSecond.toFixed(2)} QPS`
    );
    console.log(
    ...
    if (sequentialResult.metrics.latency.p95 > 100) {
      console.log(
        '  ⚠️  High sequential latency detected. Consider:'
      );
    ...
    if (concurrentResult.metrics.latency.p95 > 200) {
      console.log(
        '  ⚠️  High concurrent latency detected. Consider:'
      );
