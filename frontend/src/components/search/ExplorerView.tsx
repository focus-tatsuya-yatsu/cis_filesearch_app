...
/**
 * ExplorerView Component (Updated)
 *
 * Explorer-style view with collapsible sidebar
 *
 * Changes:
 * - Integrated collapsible Sidebar component
  ...
  return (
    <div className="h-[600px] bg-white/90 dark:bg-[#1C1C1E]/90 backdrop-blur-xl border border-[#D1D1D6]/30 dark:border-[#38383A]/30 rounded-2xl overflow-hidden shadow-sm">
      <PanelGroup direction="horizontal">
        ...
        {/* 右パネル: 検索結果 */}
        <Panel defaultSize={isCollapsed ? 95 : 75}>
