...
export const HierarchicalFilterPanel: FC<HierarchicalFilterPanelProps> = ({
  ...
  return (
    <div
      className={`bg-white dark:bg-[#1C1C1E] rounded-xl shadow-sm border border-[#D2D2D7] dark:border-[#3A3A3C] ${className}`}
    >
      {/* パネルヘッダー */}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {filterSummary && (
                <p className="text-sm text-[#6E6E73] dark:text-[#8E8E93] mt-0.5">{filterSummary}</p>
              )}
            </div>
          </div>
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              {server.description && (
                                <span
                                  className={`text-sm ml-2 ${isSelected ? 'text-blue-100' : 'text-[#6E6E73] dark:text-[#8E8E93]'}`}
                                >
                                  ({server.description})
                                </span>
                              )}
